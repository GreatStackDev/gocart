# Contributing to tradrsAvenue

Thank you for considering contributing to **tradrsAvenue**!
...
- Use **Next.js**, **Tailwind CSS**, and the **Astryx design system** for all UI work
