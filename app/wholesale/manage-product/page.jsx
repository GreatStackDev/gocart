            ...
            <table className="w-full max-w-4xl text-left ring ring-slate-200 rounded overflow-hidden text-sm">
                <thead className="bg-slate-50 text-gray-700 uppercase tracking-wider">
                    <tr>
                        ...
                        {/* Added Quantity Header and centered it */}
                ...
                <tbody className="text-slate-700">
                    {products.map((product) => (
                        <tr key={product.id} className="border-t border-gray-200 hover:bg-gray-50">
                            {/* Added whitespace-nowrap and min-w-max to prevent Name from wrapping/collapsing */}
                            <td className="px-4 py-3 whitespace-nowrap min-w-max">
                            ...
                            {/* Added whitespace-nowrap to prevent Price from wrapping */}
                            <td className="px-4 py-3 whitespace-nowrap">{currency} {product.price.toLocaleString()}</td>
                            {/* Added Quantity Data Cell and centered it */}
